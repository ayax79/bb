 ...
 * There several {@link com.blackbox.Status} method that pertain specifically to users. If a user should not be active in the system
 * the user should be marked as {@link com.blackbox.Status#DELETED}.
 * <p/>
 * <h5>Status values as they pertain to users</h5>
 * <ul>
 * <li>{@link com.blackbox.Status#ENABLED} - User is enabled and able to access the site as normal.<li>
 * <li>{@link com.blackbox.Status#DISABLED} - User is disabled and denied login. Content remains visible.</li>
 * <li>{@link com.blackbox.Status#DELETED} - User is denied login and their content is nolonger visible.</li>
 * <li>{@link com.blackbox.Status#UNVERIFIED} - User has not yet verified their registration. Login is denied until they click on the verification link in their email.</li>
 * </ul>
 *
...
public interface IUserManager {
     ...
     * {@link com.blackbox.user.User#createUser()} method.
     * <p/>
