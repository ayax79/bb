    ...
    <div class="main-content">
        ...
        <div class="span-24 main-col">
            <div class="settings-content">
                <h2>Whatcha wanna do?</h2>
                <ol>
                    <li><s:link beanclass="com.blackbox.presentation.action.admin.EventsAdminActionBean" event="importEvents">Import events from a feed</s:link></li>
                </ol>
            </div>
