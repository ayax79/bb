<%@ tag language="java" %>
<%@ attribute name="field" required="true" type="com.blackbox.user.profile.ProfileField"  description="The profile field we should render a tag for" %>
...
<%@ tag import="com.blackbox.user.profile.ProfileField.FieldType" %>
