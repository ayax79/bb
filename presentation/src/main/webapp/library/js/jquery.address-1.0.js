    ...
    $.address = (function () {
        ...
        var _load = function() {
            if (!_loaded) {
                ...
                if (_msie && _version < 8) {
					/*
					Matt's hackage to make this shit work in IE7
					This is untested in IE6
					 */
					...
					_d.body.appendChild(_iframe);
					
					/* original code from generating iframe and getting a reference to it.
