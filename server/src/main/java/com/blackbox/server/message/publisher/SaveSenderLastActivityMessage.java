 ...
 * @version $Revision: $
 */
public class SaveSenderLastActivityMessage {
    final private static Logger logger = LoggerFactory.getLogger(SaveSenderLastActivityMessage.class);
...
//                    message.setAccessControlList(cloneAccessControlList(message.getAccessControlList()));
                    activityStreamDao.setLatestActivity(message);
                }
            } catch (Exception t) {
