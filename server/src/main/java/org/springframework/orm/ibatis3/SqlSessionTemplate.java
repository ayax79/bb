 ...
 * for plain query/insert/save/delete operations. However, for more complex
 ...
 *         sqlSession.getMapper(MyMapper.class).save(parameterObject);
 *         sqlSession.save(&quot;MyMapper.save&quot;, otherParameterObject);
 *         return null;
 *     }
 * }, ExecutorType.BATCH);
 * </pre>
...
public class SqlSessionTemplate extends JdbcAccessor implements SqlSessionOperations {
    ...
    // we can't get to T here since we don't have SqlSessionCallback source and that returns object...
